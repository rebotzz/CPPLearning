...
//	cout << s1 << endl;
//	int pos = s1.find('4');
//	s1.replace(pos, 4, "rrr");
//	cout << s1 << endl;
//
//	//pos = s1.find_first_of("321", pos + 1);
//	pos = s1.find_first_of("321");
//	cout << s1[pos] << " pos: " << pos << endl;
//	pos = s1.rfind("0");
//	cout << s1[pos] << " pos: " << pos << endl;
//	pos = s1.find_first_not_of("12345689");
//	cout << s1[pos] << " pos: " << pos << endl;
//	pos = s1.find_last_of("r");
//	cout << s1[pos] << " pos: " << pos << endl;
//	pos = s1.find_last_not_of("1346870");
//	cout << s1[pos] << " pos: " << pos << endl;
//	pos = s1.find_last_of("r", string::npos);
//	cout << s1[pos] << " pos: " << pos << endl;
//
//	//.c_str()
...
//	cout << s1.compare(s1) << " ";
//	cout << s1.compare(s2) << " ";
//	cout << s1.compare(5, 5, s3) << endl;
//	cout << s1.compare(5, 5, s3,0,3) << endl;
//
//
//
//	return 0;
